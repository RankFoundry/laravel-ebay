 ...
 * @property \Rankfoundry\eBaySDK\Account\Enums\RefundMethodEnum $refundMethod
 * @property string $restockingFeePercentage
 * @property string $returnInstructions
 * @property \Rankfoundry\eBaySDK\Account\Enums\ReturnMethodEnum $returnMethod
 * @property \Rankfoundry\eBaySDK\Account\Types\TimeDuration $returnPeriod
 * @property string $returnPolicyId
 * @property boolean $returnsAccepted
 * @property \Rankfoundry\eBaySDK\Account\Enums\ReturnShippingCostPayerEnum $returnShippingCostPayer
 * @property \Rankfoundry\eBaySDK\Account\Types\ErrorDetailV3[] $warnings
 */
class SetReturnPolicyResponse extends \Rankfoundry\eBaySDK\Types\BaseType
{
    /**
