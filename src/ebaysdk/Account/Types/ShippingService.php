...
/**
 *
 * @property \Rankfoundry\eBaySDK\Account\Types\Amount $additionalShippingCost
 * @property boolean $buyerResponsibleForPickup
 * @property boolean $buyerResponsibleForShipping
 * @property \Rankfoundry\eBaySDK\Account\Types\Amount $cashOnDeliveryFee
 * @property boolean $freeShipping
 * @property string $shippingCarrierCode
 * @property \Rankfoundry\eBaySDK\Account\Types\Amount $shippingCost
 * @property string $shippingServiceCode
 * @property \Rankfoundry\eBaySDK\Account\Types\RegionSet $shipToLocations
 * @property integer $sortOrder
 * @property \Rankfoundry\eBaySDK\Account\Types\Amount $surcharge
 */
class ShippingService extends \Rankfoundry\eBaySDK\Types\BaseType
{
    /**
