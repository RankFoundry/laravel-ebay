...
/**
 *
 * @property \Rankfoundry\eBaySDK\Account\Types\Amount $maxSoldInventoryValue
 * @property integer $maxSoldQuantity
 * @property \Rankfoundry\eBaySDK\Account\Types\Amount $minSoldInventoryValue
 * @property integer $minSoldQuantity
 * @property \Rankfoundry\eBaySDK\Account\Types\TimeDuration $period
 */
class SoldAggregatedMetrics extends \Rankfoundry\eBaySDK\Types\BaseType
{
    /**
