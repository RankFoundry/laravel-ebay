<?php
namespace Rankfoundry\eBaySDK\Analytics\Services;

/**
 * Base class for the Analytics service.
 */
class AnalyticsBaseService extends \Rankfoundry\eBaySDK\Services\BaseRestService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \Rankfoundry\eBaySDK\Analytics\Services\AnalyticsService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string'],
