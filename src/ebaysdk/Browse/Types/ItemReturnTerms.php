 ...
 * @property \Rankfoundry\eBaySDK\Browse\Enums\RefundMethodEnum $refundMethod
 * @property string $restockingFeePercentage
 * @property string $returnInstructions
 * @property \Rankfoundry\eBaySDK\Browse\Enums\ReturnMethodEnum $returnMethod
 * @property \Rankfoundry\eBaySDK\Browse\Types\TimeDuration $returnPeriod
 * @property boolean $returnsAccepted
 * @property \Rankfoundry\eBaySDK\Browse\Enums\ReturnShippingCostPayerEnum $returnShippingCostPayer
 */
class ItemReturnTerms extends \Rankfoundry\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'returnPeriod' => [
            'type' => 'Rankfoundry\eBaySDK\Browse\Types\TimeDuration',
            'repeatable' => false,
            'attribute' => false,
