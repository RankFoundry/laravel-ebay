 ...
 * @property \Rankfoundry\eBaySDK\BusinessPoliciesManagement\Types\Amount $codFee
 * @property boolean $fastShipping
 * @property \Rankfoundry\eBaySDK\BusinessPoliciesManagement\Types\Amount $shippingServiceAdditionalCost
 * @property \Rankfoundry\eBaySDK\BusinessPoliciesManagement\Types\Amount $shippingServiceCost
 * @property \Rankfoundry\eBaySDK\BusinessPoliciesManagement\Types\Amount $shippingSurcharge
 * @property \Rankfoundry\eBaySDK\BusinessPoliciesManagement\Types\Amount $shippingOverrideFee
 * @property boolean $buyerResponsibleForShipping
 */
class ShippingPolicyService extends \Rankfoundry\eBaySDK\Types\BaseType
{
    /**
