 ...
 */
class ComplianceBaseService extends \Rankfoundry\eBaySDK\Services\BaseRestService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \Rankfoundry\eBaySDK\Compliance\Services\ComplianceService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string'],
