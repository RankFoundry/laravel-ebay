<?php
namespace Rankfoundry\eBaySDK\Feed\Services;

/**
 * Base class for the Feed service.
 */
class FeedBaseService extends \Rankfoundry\eBaySDK\Services\BaseRestService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \Rankfoundry\eBaySDK\Feed\Services\FeedService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string'],
