 ...
 */
class HalfFindingBaseService extends \Rankfoundry\eBaySDK\Services\BaseService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \Rankfoundry\eBaySDK\HalfFinding\Services\HalfFindingService::API_VERSION
            ],
            'globalId' => [
                'valid' => ['string']
            ]
