<?php
namespace Rankfoundry\eBaySDK\Inventory\Services;

/**
 * Base class for the Inventory service.
 */
class InventoryBaseService extends \Rankfoundry\eBaySDK\Services\BaseRestService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \Rankfoundry\eBaySDK\Inventory\Services\InventoryService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string'],
