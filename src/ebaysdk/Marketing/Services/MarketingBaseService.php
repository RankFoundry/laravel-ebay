 ...
 */
class MarketingBaseService extends \Rankfoundry\eBaySDK\Services\BaseRestService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \Rankfoundry\eBaySDK\Marketing\Services\MarketingService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string'],
