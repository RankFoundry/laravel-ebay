...
/**
 *
 * @property \Rankfoundry\eBaySDK\Marketing\Types\Amount $forEachAmount
 * @property integer $forEachQuantity
 * @property \Rankfoundry\eBaySDK\Marketing\Types\Amount $minAmount
 * @property integer $minQuantity
 * @property integer $numberOfDiscountedItems
 */
class DiscountSpecification extends \Rankfoundry\eBaySDK\Types\BaseType
{
    /**
