 ...
 */
class MerchandisingBaseService extends \Rankfoundry\eBaySDK\Services\BaseService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \Rankfoundry\eBaySDK\Merchandising\Services\MerchandisingService::API_VERSION
            ],
            'globalId' => [
                'valid' => ['string']
            ]
