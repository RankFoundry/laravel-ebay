...
/**
 *
 * @property \Rankfoundry\eBaySDK\MerchantData\Types\AmountType $ConvertedMaxBid
 * @property \Rankfoundry\eBaySDK\MerchantData\Types\AmountType $MaxBid
 * @property integer $QuantityBid
 * @property integer $QuantityWon
 * @property boolean $Winning
 */
class BiddingDetailsType extends \Rankfoundry\eBaySDK\Types\BaseType
{
    /**
