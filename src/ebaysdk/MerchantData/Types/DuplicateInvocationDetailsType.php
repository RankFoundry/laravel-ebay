 ...
 * @property \Rankfoundry\eBaySDK\MerchantData\Enums\InvocationStatusType $Status
 * @property string $InvocationTrackingID
 */
class DuplicateInvocationDetailsType extends \Rankfoundry\eBaySDK\Types\BaseType
{
    /**
