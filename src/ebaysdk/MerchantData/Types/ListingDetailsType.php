 ...
 * @property \Rankfoundry\eBaySDK\MerchantData\Types\AmountType $ConvertedBuyItNowPrice
 * @property \Rankfoundry\eBaySDK\MerchantData\Types\AmountType $ConvertedStartPrice
 * @property \Rankfoundry\eBaySDK\MerchantData\Types\AmountType $ConvertedReservePrice
 ...
 * @property \Rankfoundry\eBaySDK\MerchantData\Types\AmountType $MinimumBestOfferPrice
 * @property string $LocalListingDistance
 * @property string $TCROriginalItemID
 * @property string $ViewItemURLForNaturalSearch
 * @property \Rankfoundry\eBaySDK\MerchantData\Types\AmountType $BestOfferAutoAcceptPrice
 * @property \Rankfoundry\eBaySDK\MerchantData\Enums\EndReasonCodeType $EndingReason
 */
class ListingDetailsType extends \Rankfoundry\eBaySDK\Types\BaseType
{
    /**
