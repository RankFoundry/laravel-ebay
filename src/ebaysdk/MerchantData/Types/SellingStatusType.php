 ...
 * @property \Rankfoundry\eBaySDK\MerchantData\Types\AmountType $BidIncrement
 * @property \Rankfoundry\eBaySDK\MerchantData\Types\AmountType $ConvertedCurrentPrice
 * @property \Rankfoundry\eBaySDK\MerchantData\Types\AmountType $CurrentPrice
 * @property \Rankfoundry\eBaySDK\MerchantData\Types\UserType $HighBidder
 * @property integer $LeadCount
 * @property \Rankfoundry\eBaySDK\MerchantData\Types\AmountType $MinimumToBid
 * @property integer $QuantitySold
 * @property boolean $ReserveMet
 * @property boolean $SecondChanceEligible
 * @property integer $BidderCount
 * @property \Rankfoundry\eBaySDK\MerchantData\Enums\ListingStatusCodeType $ListingStatus
 * @property \Rankfoundry\eBaySDK\MerchantData\Types\AmountType $FinalValueFee
 * @property \Rankfoundry\eBaySDK\MerchantData\Types\PromotionalSaleDetailsType $PromotionalSaleDetails
 * @property boolean $AdminEnded
 * @property boolean $SoldAsBin
 * @property integer $QuantitySoldByPickupInStore
 * @property \Rankfoundry\eBaySDK\MerchantData\Types\SuggestedBidValueType $SuggestedBidValues
 */
class SellingStatusType extends \Rankfoundry\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'PromotionalSaleDetails' => [
            'type' => 'Rankfoundry\eBaySDK\MerchantData\Types\PromotionalSaleDetailsType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'SuggestedBidValues' => [
            'type' => 'Rankfoundry\eBaySDK\MerchantData\Types\SuggestedBidValueType',
            'repeatable' => false,
            'attribute' => false,
