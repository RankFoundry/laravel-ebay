 ...
 */
class MetadataBaseService extends \Rankfoundry\eBaySDK\Services\BaseRestService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \Rankfoundry\eBaySDK\Metadata\Services\MetadataService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string'],
