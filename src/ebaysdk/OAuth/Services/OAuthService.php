<?php
namespace Rankfoundry\eBaySDK\OAuth\Services;

use Rankfoundry\eBaySDK\ConfigurationResolver;
use Rankfoundry\eBaySDK\Credentials\CredentialsProvider;
use Rankfoundry\eBaySDK\UriResolver;
use \Rankfoundry\eBaySDK as Functions;
...
class OAuthService
{
    ...
    private static $operations = [
        'getUserToken' => [
            ...
            'responseClass' => '\Rankfoundry\eBaySDK\OAuth\Types\GetUserTokenRestResponse',
            'params' => [
            ]
        ],
        'refreshUserToken' => [
            'method' => 'POST',
            'resource' => 'oauth2/token',
            'responseClass' => '\Rankfoundry\eBaySDK\OAuth\Types\RefreshUserTokenRestResponse',
            'params' => [
            ]
        ],
        'getAppToken' => [
            'method' => 'POST',
            'resource' => 'oauth2/token',
            'responseClass' => '\Rankfoundry\eBaySDK\OAuth\Types\GetAppTokenRestResponse',
            'params' => [
            ]
        ]
    ];
    ...
    /**
     * @var \Rankfoundry\eBaySDK\ConfigurationResolver Resolves configuration options.
     */
    private $resolver;

    /**
     * @var \Rankfoundry\eBaySDK\UriResolver Resolves uri parameters.
     */
    private $uriResolver;
    ...
    public static function getConfigDefinitions()
    {
        return [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \Rankfoundry\eBaySDK\OAuth\Services\OAuthService::API_VERSION,
                'required' => true
            ],
            'profile' => [
                'valid' => ['string'],
                'fn'    => 'Rankfoundry\eBaySDK\applyProfile',
            ],
            'credentials' => [
                'valid'   => ['Rankfoundry\eBaySDK\Credentials\CredentialsInterface', 'array', 'callable'],
                'fn'      => 'Rankfoundry\eBaySDK\applyCredentials',
                'default' => [CredentialsProvider::class, 'defaultProvider']
            ],
            'debug' => [
                'valid'   => ['bool', 'array'],
                'fn'      => 'Rankfoundry\eBaySDK\applyDebug',
                'default' => false
            ],
            'httpHandler' => [
                'valid'   => ['callable'],
                'default' => 'Rankfoundry\eBaySDK\defaultHttpHandler'
            ],
            'httpOptions' => [
                'valid'   => ['array'],
                'default' => [
     ...
     *
     * @return \Rankfoundry\eBaySDK\Credentials\CredentialsInterface
     */
    ...
    /**
     * @param \Rankfoundry\eBaySDK\OAuth\Types\GetUserTokenRestRequest $request
     * @return \Rankfoundry\eBaySDK\OAuth\Types\GetUserTokenRestResponse
     */
    public function getUserToken(\Rankfoundry\eBaySDK\OAuth\Types\GetUserTokenRestRequest $request)
    {
     ...
     */
    public function getUserTokenAsync(\Rankfoundry\eBaySDK\OAuth\Types\GetUserTokenRestRequest $request)
    {
        if (!$request) {
            $request = new \Rankfoundry\eBaySDK\OAuth\Types\GetUserTokenRestRequest();
        }
    ...
    /**
     * @param \Rankfoundry\eBaySDK\OAuth\Types\RefreshUserTokenRestRequest $request
     * @return \Rankfoundry\eBaySDK\OAuth\Types\RefreshUserTokenRestResponse
     */
    public function refreshUserToken(\Rankfoundry\eBaySDK\OAuth\Types\RefreshUserTokenRestRequest $request)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function refreshUserTokenAsync(\Rankfoundry\eBaySDK\OAuth\Types\refreshUserTokenRestRequest $request)
    {
        if (!$request) {
            $request = new \Rankfoundry\eBaySDK\OAuth\Types\RefreshUserTokenRestRequest();
        }
        if (!isset($request->grant_type)) {
    ...
    /**
     * @param \Rankfoundry\eBaySDK\OAuth\Types\GetAppTokenRestRequest $request
     * @return \Rankfoundry\eBaySDK\OAuth\Types\GetAppTokenRestResponse
     */
    public function getAppToken(\Rankfoundry\eBaySDK\OAuth\Types\GetAppTokenRestRequest $request = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAppTokenAsync(\Rankfoundry\eBaySDK\OAuth\Types\GetAppTokenRestRequest $request = null)
    {
        if (!$request) {
            $request = new \Rankfoundry\eBaySDK\OAuth\Types\GetAppTokenRestRequest();
        }
        if (!isset($request->grant_type)) {
     ...
     * @param \Rankfoundry\eBaySDK\Types\BaseType $request Request object containing the request information.
     *
     * @return \GuzzleHttp\Promise\PromiseInterface A promise that will be resolved with an object created from the JSON response.
     */
    private function callOperationAsync($name, \Rankfoundry\eBaySDK\Types\BaseType $request = null)
    {
