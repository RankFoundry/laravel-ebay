<?php
namespace Rankfoundry\eBaySDK\OAuth\Types;

use Rankfoundry\eBaySDK\StatusCodeTrait;
use Rankfoundry\eBaySDK\HttpHeadersTrait;
 ...
 */
class RefreshUserTokenRestResponse  extends \Rankfoundry\eBaySDK\Types\BaseType
{
    use StatusCodeTrait;
