...
{
    /**
     * @param mixed A PHP object derived from Rankfoundry\eBaySDK\Types\BaseType
    ...
    private static function assignProperties(\Rankfoundry\eBaySDK\Types\BaseType $object, array $properties)
    {
