 ...
 * @property \Rankfoundry\eBaySDK\PostOrder\Enums\AddressTypeEnum $addressType
 * @property string $city
 * @property \Rankfoundry\eBaySDK\PostOrder\Enums\CountryCodeEnum $country
 * @property string $county
 * @property boolean $isTransliterated
 * @property string $nationalRegion
 * @property string $postalCode
 * @property \Rankfoundry\eBaySDK\PostOrder\Enums\LanguageScriptEnum $script
 * @property string $stateOrProvince
 * @property \Rankfoundry\eBaySDK\PostOrder\Enums\LanguageScriptEnum $transliteratedFromScript
 * @property \Rankfoundry\eBaySDK\PostOrder\Enums\WorldRegionEnum $worldRegion
 */
