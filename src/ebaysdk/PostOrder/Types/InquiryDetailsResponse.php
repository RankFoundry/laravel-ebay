 ...
 * @property \Rankfoundry\eBaySDK\PostOrder\Types\InquiryDetails $inquiryDetails
 * @property \Rankfoundry\eBaySDK\PostOrder\Types\ClaimHistoryResponse $inquiryHistoryDetails
 * @property string $inquiryId
 * @property integer $inquiryQuantity
 * @property \Rankfoundry\eBaySDK\PostOrder\Types\ItemDetails $itemDetails
 * @property string $itemId
 * @property \Rankfoundry\eBaySDK\PostOrder\Types\ReturnAddress $returnDetails
 * @property \Rankfoundry\eBaySDK\PostOrder\Types\DateTime $sellerMakeItRightByDate
 * @property \Rankfoundry\eBaySDK\PostOrder\Types\Amount $shippingCost
 * @property string $state
 * @property string $status
 * @property string $transactionId
 * @property string $viewPPTrasanctionUrl
 */
class InquiryDetailsResponse extends \Rankfoundry\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'inquiryDetails' => [
            'type' => 'Rankfoundry\eBaySDK\PostOrder\Types\InquiryDetails',
            'repeatable' => false,
            'attribute' => false,
        ...
        'itemDetails' => [
            'type' => 'Rankfoundry\eBaySDK\PostOrder\Types\ItemDetails',
            'repeatable' => false,
            'attribute' => false,
