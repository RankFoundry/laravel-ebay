...
/**
 *
 * @property \Rankfoundry\eBaySDK\PostOrder\Types\DateTime $holdCreationDate
 * @property string $holdReferenceId
 * @property \Rankfoundry\eBaySDK\PostOrder\Types\DateTime $holdReleaseDate
 * @property \Rankfoundry\eBaySDK\PostOrder\Enums\ReturnHoldStatusEnum $holdStatus
 * @property string $holdTransactionId
 */
class ReturnHoldInfoType extends \Rankfoundry\eBaySDK\Types\BaseType
{
    /**
