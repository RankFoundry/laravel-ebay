 ...
 * @property \Rankfoundry\eBaySDK\PostOrder\Types\Text $sellerComments
 * @property boolean $shippedWithTracking
 * @property string $shippingCarrierName
 * @property \Rankfoundry\eBaySDK\PostOrder\Types\DateTime $shippingDate
 * @property string $trackingNumber
 */
class ShipmentInfoRequest extends \Rankfoundry\eBaySDK\Types\BaseType
{
    /**
