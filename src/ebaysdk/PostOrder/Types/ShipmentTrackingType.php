 ...
 * @property \Rankfoundry\eBaySDK\PostOrder\Types\DateTime $actualDeliveryDate
 * @property \Rankfoundry\eBaySDK\PostOrder\Types\DateTime $actualShipDate
 * @property string $carrierEnum
 * @property integer $carrierId
 * @property string $carrierName
 * @property string $carrierUsed
 * @property \Rankfoundry\eBaySDK\PostOrder\Types\DateTime $deliveryDate
 * @property \Rankfoundry\eBaySDK\PostOrder\Enums\TrackingStatusEnum $deliveryStatus
 * @property \Rankfoundry\eBaySDK\PostOrder\Types\ReturnAddressType $destinationAddress
 * @property string $errorCode
 * @property string $labelAvailableUntilDate
 * @property \Rankfoundry\eBaySDK\PostOrder\Types\DateTime $labelDate
 * @property string $labelId
 * @property boolean $labelPrintExpired
 * @property boolean $labelVoidExpired
 * @property boolean $markAsReceived
 * @property \Rankfoundry\eBaySDK\PostOrder\Types\DateTime $maxDeliveryEstimate
 * @property \Rankfoundry\eBaySDK\PostOrder\Types\DateTime $minDeliveryEstimate
 * @property \Rankfoundry\eBaySDK\PostOrder\Types\ReturnAddressType $originAddress
 * @property \Rankfoundry\eBaySDK\PostOrder\Types\DateTime $shipDate
 * @property string $shipmentId
 * @property string $shippedBy
 * @property \Rankfoundry\eBaySDK\PostOrder\Enums\ShippingMethodEnum $shippingMethod
 * @property string $trackingNumber
 */
class ShipmentTrackingType extends \Rankfoundry\eBaySDK\Types\BaseType
{
    /**
