 ...
 *
 * @property string $SKU
 * @property \Rankfoundry\eBaySDK\RelatedItemsManagement\Types\Discount $discount
 * @property integer $rank
 * @property string $title
 * @property integer $maxQtyForSinglePrimary
 */
class RelatedProduct extends \Rankfoundry\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'discount' => [
            'type' => 'Rankfoundry\eBaySDK\RelatedItemsManagement\Types\Discount',
            'repeatable' => false,
            'attribute' => false,
