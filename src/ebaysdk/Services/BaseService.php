<?php
namespace Rankfoundry\eBaySDK\Services;

use Rankfoundry\eBaySDK\Parser\XmlParser;
...
abstract class BaseService
{
     ...
     */
    protected function callOperationAsync($name, \Rankfoundry\eBaySDK\Types\BaseType $request, $responseClass)
    {
        $url = $this->getUrl();
     ...
     */
    protected function buildRequestBody(\Rankfoundry\eBaySDK\Types\BaseType $request)
    {
     ...
     */
    private function buildXopDocument(\Rankfoundry\eBaySDK\Types\BaseType $request)
    {
        return sprintf(
            '%s%s%s%s%s',
     ...
     */
    protected function buildMultipartFormDataXMLPayload(\Rankfoundry\eBaySDK\Types\BaseType $request)
    {
        return sprintf(
            '%s%s%s',
            '--boundary'.self::CRLF,
