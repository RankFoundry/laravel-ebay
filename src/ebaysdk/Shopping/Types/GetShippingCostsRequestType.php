 ...
 * @property \Rankfoundry\eBaySDK\Shopping\Enums\CountryCodeType $DestinationCountryCode
 * @property boolean $IncludeDetails
 */
class GetShippingCostsRequestType extends \Rankfoundry\eBaySDK\Shopping\Types\AbstractRequestType
{
    /**
