 ...
 * @property \Rankfoundry\eBaySDK\Shopping\Enums\FeedbackRatingStarCodeType $FeedbackRatingStar
 * @property integer $FeedbackScore
 * @property boolean $UserAnonymized
 * @property boolean $NewUser
 * @property \DateTime $RegistrationDate
 * @property \Rankfoundry\eBaySDK\Shopping\Enums\SiteCodeType $RegistrationSite
 * @property \Rankfoundry\eBaySDK\Shopping\Enums\UserStatusCodeType $Status
 * @property \Rankfoundry\eBaySDK\Shopping\Enums\SellerBusinessCodeType $SellerBusinessType
 ...
 * @property \Rankfoundry\eBaySDK\Shopping\Enums\SellerLevelCodeType $SellerLevel
 * @property boolean $TopRatedSeller
 */
class SimpleUserType extends \Rankfoundry\eBaySDK\Types\BaseType
{
    /**
