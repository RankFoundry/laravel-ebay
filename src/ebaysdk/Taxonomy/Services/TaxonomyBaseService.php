<?php
namespace Rankfoundry\eBaySDK\Taxonomy\Services;

/**
 * Base class for the Taxonomy service.
 */
class TaxonomyBaseService extends \Rankfoundry\eBaySDK\Services\BaseRestService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \Rankfoundry\eBaySDK\Taxonomy\Services\TaxonomyService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string'],
