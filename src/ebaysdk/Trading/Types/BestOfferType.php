 ...
 * @property \Rankfoundry\eBaySDK\Trading\Types\AmountType $Price
 * @property \Rankfoundry\eBaySDK\Trading\Enums\BestOfferStatusCodeType $Status
 * @property integer $Quantity
 * @property string $BuyerMessage
 * @property string $SellerMessage
 * @property \Rankfoundry\eBaySDK\Trading\Enums\BestOfferTypeCodeType $BestOfferCodeType
 * @property string $CallStatus
 */
class BestOfferType extends \Rankfoundry\eBaySDK\Types\BaseType
{
    /**
