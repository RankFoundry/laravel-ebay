 ...
 * @property \Rankfoundry\eBaySDK\Trading\Enums\GetAllBiddersModeCodeType $CallMode
 * @property boolean $IncludeBiddingSummary
 */
class GetAllBiddersRequestType extends \Rankfoundry\eBaySDK\Trading\Types\AbstractRequestType
{
    /**
