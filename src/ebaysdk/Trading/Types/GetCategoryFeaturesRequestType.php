 ...
 * @property \Rankfoundry\eBaySDK\Trading\Enums\FeatureIDCodeType[] $FeatureID
 * @property boolean $AllFeaturesForCategory
 */
class GetCategoryFeaturesRequestType extends \Rankfoundry\eBaySDK\Trading\Types\AbstractRequestType
{
    /**
