 ...
 * @property \Rankfoundry\eBaySDK\Trading\Types\CategoryItemSpecificsType[] $CategorySpecific
 * @property boolean $ExcludeRelationships
 * @property boolean $IncludeConfidence
 * @property boolean $CategorySpecificsFileInfo
 */
class GetCategorySpecificsRequestType extends \Rankfoundry\eBaySDK\Trading\Types\AbstractRequestType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'CategorySpecific' => [
            'type' => 'Rankfoundry\eBaySDK\Trading\Types\CategoryItemSpecificsType',
            'repeatable' => true,
            'attribute' => false,
