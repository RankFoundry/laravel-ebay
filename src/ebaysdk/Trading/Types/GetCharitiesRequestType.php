 ...
 * @property \Rankfoundry\eBaySDK\Trading\Enums\StringMatchCodeType $MatchType
 * @property boolean $Featured
 */
class GetCharitiesRequestType extends \Rankfoundry\eBaySDK\Trading\Types\AbstractRequestType
{
    /**
