 ...
 * @property \Rankfoundry\eBaySDK\Trading\Enums\NotificationEventTypeCodeType $Type
 * @property integer $Retries
 * @property \Rankfoundry\eBaySDK\Trading\Enums\NotificationEventStateCodeType $DeliveryStatus
 * @property \DateTime $NextRetryTime
 * @property \DateTime $DeliveryTime
 * @property string $ErrorMessage
 * @property string $DeliveryURLName
 */
class NotificationDetailsType extends \Rankfoundry\eBaySDK\Types\BaseType
{
    /**
