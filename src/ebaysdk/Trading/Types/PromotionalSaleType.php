 ...
 * @property \Rankfoundry\eBaySDK\Trading\Enums\PromotionalSaleStatusCodeType $Status
 * @property \Rankfoundry\eBaySDK\Trading\Enums\DiscountCodeType $DiscountType
 * @property double $DiscountValue
 * @property \DateTime $PromotionalSaleStartTime
 * @property \DateTime $PromotionalSaleEndTime
 * @property \Rankfoundry\eBaySDK\Trading\Enums\PromotionalSaleTypeCodeType $PromotionalSaleType
 */
class PromotionalSaleType extends \Rankfoundry\eBaySDK\Types\BaseType
{
    /**
