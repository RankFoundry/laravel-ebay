 ...
 * @property \Rankfoundry\eBaySDK\Trading\Enums\BestOfferActionCodeType $Action
 * @property string $SellerResponse
 * @property \Rankfoundry\eBaySDK\Trading\Types\AmountType $CounterOfferPrice
 * @property integer $CounterOfferQuantity
 */
class RespondToBestOfferRequestType extends \Rankfoundry\eBaySDK\Trading\Types\AbstractRequestType
{
    /**
