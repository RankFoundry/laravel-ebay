 ...
 * @property \Rankfoundry\eBaySDK\Trading\Enums\FeedbackResponseCodeType $ResponseType
 * @property string $ResponseText
 * @property string $OrderLineItemID
 */
class RespondToFeedbackRequestType extends \Rankfoundry\eBaySDK\Trading\Types\AbstractRequestType
{
    /**
