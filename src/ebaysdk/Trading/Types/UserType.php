 ...
 * @property \Rankfoundry\eBaySDK\Trading\Enums\FeedbackRatingStarCodeType $FeedbackRatingStar
 * @property boolean $IDVerified
 * @property boolean $eBayGoodStanding
 * @property boolean $NewUser
 * @property \Rankfoundry\eBaySDK\Trading\Types\AddressType $RegistrationAddress
 * @property \DateTime $RegistrationDate
 * @property \Rankfoundry\eBaySDK\Trading\Enums\SiteCodeType $Site
 * @property \Rankfoundry\eBaySDK\Trading\Enums\UserStatusCodeType $Status
 * @property string $UserID
 * @property boolean $UserIDChanged
 * @property \DateTime $UserIDLastChanged
 * @property \Rankfoundry\eBaySDK\Trading\Enums\VATStatusCodeType $VATStatus
 * @property \Rankfoundry\eBaySDK\Trading\Types\BuyerType $BuyerInfo
 * @property \Rankfoundry\eBaySDK\Trading\Types\SellerType $SellerInfo
 * @property \Rankfoundry\eBaySDK\Trading\Enums\BusinessRoleType $BusinessRole
 * @property \Rankfoundry\eBaySDK\Trading\Enums\PayPalAccountLevelCodeType $PayPalAccountLevel
 * @property \Rankfoundry\eBaySDK\Trading\Enums\PayPalAccountTypeCodeType $PayPalAccountType
 * @property \Rankfoundry\eBaySDK\Trading\Enums\PayPalAccountStatusCodeType $PayPalAccountStatus
 * @property \Rankfoundry\eBaySDK\Trading\Enums\EBaySubscriptionTypeCodeType[] $UserSubscription
 * @property boolean $eBayWikiReadOnly
 * @property integer $TUVLevel
 * @property string $VATID
 * @property boolean $MotorsDealer
 * @property \Rankfoundry\eBaySDK\Trading\Types\BiddingSummaryType $BiddingSummary
 ...
 * @property \Rankfoundry\eBaySDK\Trading\Types\MembershipDetailsType $Membership
...
class UserType extends \Rankfoundry\eBaySDK\Types\BaseType
{
    ...
    private static $propertyTypes = [
        ...
        'BuyerInfo' => [
            'type' => 'Rankfoundry\eBaySDK\Trading\Types\BuyerType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'BuyerInfo'
        ],
        'SellerInfo' => [
            'type' => 'Rankfoundry\eBaySDK\Trading\Types\SellerType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'BiddingSummary' => [
            'type' => 'Rankfoundry\eBaySDK\Trading\Types\BiddingSummaryType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'Membership' => [
            'type' => 'Rankfoundry\eBaySDK\Trading\Types\MembershipDetailsType',
            'repeatable' => false,
            'attribute' => false,
