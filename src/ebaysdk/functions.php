...
use Rankfoundry\eBaySDK\Credentials\Credentials;
use Rankfoundry\eBaySDK\Credentials\CredentialsProvider;
use Rankfoundry\eBaySDK\Credentials\CredentialsInterface;
...
function applyCredentials($value, array &$configuration)
{
    if (is_callable($value)) {
        ...
        throw new \InvalidArgumentException(
            ...
            . 'Rankfoundry\eBaySDK\Credentials\CredentialsInterface, an associative '
 ...
 *
 * @return \Rankfoundry\eBaySDK\HttpHandler
 */
...
{
    if (\Rankfoundry\eBaySDK\Sdk::$STRICT_PROPERTY_TYPES) {
        return true;
    }
